label yuri_exclusive_1:
    scene bg club_day
    with wipeleft_scene
    "I'm really enthusiastic to talk to Yuri a little bit more..."
    ...
    if books_bought == 0:
        "Hmm... I haven't go to the bookstore yesterday. And it was in my plans in my free time."
        "I'm such an idiot! How could I loss a chance like that?!"
        "Unless... She could go to another bookstore..."
        "It's the best chance to test the Save/Load script!"
    if persistent.ytellyouherbookstore == False:
        "Wait, what?! But I just went to the bookstore yesterday and I haven't seen her..."
        "Or maybe... She goes to another bookstore?"
        "It's the best chance to test the Save/Load script!"
    ...
    if persistent.ytellyouherbookstore == False:
        mc "Umm, excuse me Yuri, but..."
        y 1e "Eh?"
        mc "What's the bookstore where you bought your books?"
        mc "I'm asking this because I couldn't find something I'm looking for in my closest library."
        y 2j "Oh. Well umm..."
        y 1m "I bought these books in the bookstore ubicated in Downtown."
        y 1a "You can localize it easily because it's located next to the famous restaurant in the town."
        mc "Nice! I will check it out one day... Thanks Yuri!"
        y 3d "Ehehe~... Don't mention it. I hope we met here someday."
        mc "I could love that."
        $ persistent.ytellyouherbookstore = True
        "Now it's time to LOAD{nw}"
        mc "By the way..."
    else:
        pass
    ...
    "Jesus Christ, I never thought that Yuri will like such stories..."
    y 1c "Ahaha."
    ...
    y "S-Sorry!"
    y "I was just--!"
    mc "Ahaha... Yuri, you really apologize a lot, don't you?"
    y "I...I do?"
    ...
    "I can feel the warmth of Yuri's face, and she's in the corner of my vision..."
    "I never was so lucky, every boy in the school should feel jealous if they know this."
    "I'm very excited for this kind of experience... I hope we can repeat it again."
    ...
    "I don't know how I'll be able to keep up with her... I'm blushing, and maybe my body temperature is getting up!"
    y "Ah..."
    ...
    "..."
    "How interesting... May I should say it to her?"
    "Let's try..."
    mc "Hey, Yuri..."
    ...
    y "You...think so?"
    y "How does she?"
    "I'm quickly choose the most correct words to say this."
    ...
    y "..."
    "Oh, shit! I guess we loss the train... Say something nice, quick!"
    mc "I guess I more meant that it's kind of cute..."
    y 3q "A-Ah--"
    y "What are you saying all of a sudden...?"
    y "I...!"
    "ohfuckohfuckfuckfuckfuck-{nw}"
    show monika 4 at l31
    m "Okay, everyone!"
    show yuri 3n at h11
    y "...!"
    mc "OH SHIT!!!"
    "Monika scared me the shit up! Jesus christ, where did she came from?"
    "Yuri also has the same expression like me..."
    ...
    "I do the same thing, and suddently plop back to my chair, almost falling with chair and everything."
    ...
    "My nervousness rises. It was my fault of Yuri's actual state."
    show monika at t31 zorder 2
    show yuri at f11 zorder 3
    y 3v "Ah, it's not..."
    y "...It's fine."
    ...
    mc "Alright!"
    mc "Thanks for the time shared Yuri..."
    y "D-Don't mention it... I, also thank you for that..."
    "I pat her shoulder while I smile gratefully."
    mc "Hehe~!"
    show yuri at thide zorder 1
    hide yuri
    "I stand up."
...
label yuri_exclusive_2_ch3:
    ...
    mc "Of course not, I could love that."
    ...
    show yuri 2e
    mc "Eh?"
    "What the fuck do you care Monika?"
    "Suddently, I have an disgust expression at Monika for her intrusiveness."
    mc "We're just...Yuri was going to make some tea, so..."
    "I suddenly realize how weird it sounds to explain this to Monika. I could send her to the fuck out of our business, but she's the President and the #1 popular girl, my reputation could be in game."
    ...
    mc "--!"
    "My mouth gapes."
    "She said exactly what I wanted to say. I never though she can have this attitude..."
    "But honestly, I'm even worse. I would have insulted her very ugly."
    show monika at f31 zorder 3
    m 5a "I..."
    ...
    mc "Also, I was very irritated for her attitude too. I could have insulted her horribly in front of everyone."
    mc "I didn't do it because of respect."
    play music t9 fadeout 1.0
    y 4a "[player]..."
    y "How come even when I do something bad..."
    y "You're being nice to me?"
    mc "Because nothing that you do is as bad as you make it seem in your head."
    mc "Nobody's perfect."
    ...
    "I pat gently her shoulders and smile at her face."
    ...
    "I feel kind of awkward hugging Yuri so suddenly, considering we met 2 days ago..."
    "But I'm doing my best to help Yuri feel better."
    mc "..."
    y 3u "Ah-- Yeah... The water pitcher!"
    y "Shall we go?"
    mc "Y-Yeah."
    show yuri at thide zorder 1
    hide yuri
    ...
    y "That's why a girl like Sayori loves you very much."
    mc "That's... nice to hear it from you."
    "Yuri wasn't kidding..."
    ...
    "I bought it exactly for this case. That's why it's not available in the inventory, hehe."
    ...
    "Except this time..."
    "Our bodies are even closer to each other. I don't want to imagine how I will suffer with the incoming erection.{nw}"
    ...
    "Jesus christ! What a kind of situation..."
    ...
    "It's getting even better, I hope we can{nw}"
    stop music
    window hide(None)
    scene bg club_day
    window show(None)
    ...
    "Yuri jolts back."
    show monika 1i
    mc "OH...MY...FUCKING...GOOOOD-!!!"
    m "[player], are you okay?"
    show monika 1h
    mc "Wha-?"
    "Oh shit... Now I'm fucked up..."
    show yuri 3n
    mc "Y-Ye-Yeah... I-I'm okay..."
    "I make a forced smile at Yuri..."
    m "... ... ..."
    m 1k "It's good then!"
    play music t3
    show monika at f31 zorder 3
    m "Because it's time to share poems!"
    "Phew..."
    "I wipe the sweat off my forehead with my arm.."
    ...
    "Fuck you Monika!"
    "While I say that to Monika in my mind, I show her the fuck you sign with my hand and a angry expression... While she's doesn't notice it."
    y 4c "I'll..."
    y "I'll take care of the cups..."
    "Damn, I forgot Yuri was watching me doing that. I hope she doesn't give me away..."
    mc "Y-Yeah..."
    show yuri at thide zorder 1
    hide yuri
    ...
    "I take a break in my chair, all so that I end up stamping my head against my table."
    "Why did Monika suddenly become so intrusive in my affairs???"
    "Did she fall in love with me or what?"
    return
