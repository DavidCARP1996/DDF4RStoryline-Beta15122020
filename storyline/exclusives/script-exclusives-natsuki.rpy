label natsuki_exclusive_1:
    ...
    mc "Yeah, I know how that feels."
    mc "Hmm..."
    mc "Manga..."
    n 2c "You read manga, right?"
    mc "Ah--"
    mc "...Not exactly but, I'm reading some digital copies of Soccer Winners on my computer. I don't know if that counts..."
    ...
    "Otherwise, people like Monika will enjoy fuckin' bullying you for reading \"comics for kids\"."
    ...
    "I am not interested in such stuff... I'm more into the \"shonen\" thing."
    ...
    "It looks like when I was appasionate with soccer when I reviewed Soccer Winners years ago."
    ...
    mc "I'm a loser since an accident I suffered two years ago... And I'm pretty bad socializing too, so I cannot find some kind of friends so easy."
    mc "Fortunatelly for me, I have two friends apart from Sayori which I can share anything without beign judged. They've been supporting me a lot time."
    ...
    "That reminds me..."
    "No! I won't talk about that now!"
...
label natsuki_exclusive_2_ch3:
    ...
    hide monika
    mc "Jesus Christ..."
    "It's obvious, Monika did that on purpose..."
    n 1r "Ugh..."
    ...
    "{i}(Who the fuck was it who told me not to fucking help...? Geez!){/i}"
    ...
    "Once she realizes, I'll be fucking dead!"
    show n_cg2_base at n_cg2_wiggle
    n "Hup--"
    ...
    "Fucking damn it! I can't stand the pain!"
    show monika at f31 zorder 3
    m 1l "I know, I know, don't worry~"
    show monika at thide zorder 1
    hide monika
    "Monika says that quietly to me."
    "What the fucking hell is going on here?! She must had took me by the cock and report me to the directives..."
    "Unless..."
    stop music fadeout 1
    n 1p "Oh no...!"
    n "My...my..."
