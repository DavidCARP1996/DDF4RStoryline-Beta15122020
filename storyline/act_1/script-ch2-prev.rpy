label ch2_prev:
    ...
    mc "In any case, I want to take a breakfast in that cafeteria once again..."
    ...
    label ch2_prev_go_to_cafe:
        ...
        menu:
            ...
            "Strawberry smoothie & portion of cake - $320":
                ...
                $ money -= 320
                pass
        mc "Hmm... I guess I'll buy two caramel sandwichs. One for me and another for Sayori, just in case."
        $ bag_inventory.add_item("caramelsandwich", score=2)
        "[player] bought 2 Caramel sandwich."
...
label ch2_prev_go_school_A:
    ...
    menu:
        ...
        "Enter to her house.":
            ...
            show sayori turned pijama lup rup b1a e2a ml nl at t11 zorder 2
            "Ohmygod!"
            show sayori b2c e4c at h11
            ...
            s ldown rdown b1a e2a "Eh?! [player]???"
            mc "Y-yeah..."
            s lup rup b1b e1a mi n1 "Oh my god! I'm so sorry, I thought you was a pervert."
            ...
            s ldown rdown b1b e1b me "... ... ..."
            mc "In fact, I deserve it."
            show sayori e1a b1c
            mc "I should have knock the door... or shouldn't have sneaked in in first place."
            s b1b ma "..."
            s rup "How could an girl like me have an awesome friend like you?"
            mc "Umm... I guess it's viceversa."
            s mc n2 e1b "Do you think so?"
            s lup b1a e4b n1 "Hahahahaha! You're great, you know that?"
            mc "You too Sayori..."
            mc "Hey, by the way..."
            show sayori ldown rdown e1a me
            mc "Put your school uniform and let's go, we'll be late."
            s b1b ma "Oh, sorry! Hehe~"
            s rup b1a mb "Wait me in the living room, okay? You can pick something from the fridge if you want."
...
label ch2_prev_go_school_B:
    ...
    $ HKBShowButtons()
    mc "..."
    mc "You know, it feels weird walking to the school without Sayori, but she's not coming up to chasing me like she does before."
...
label ch2_prev_schooltime:
    ...
    if sayori_wait2 == True:
        "She's always finding a place where we can eat together."
        ...
        pass
    if sayori_wait2 == False:
        "Shit! We haven't meet in the entrance either. Where did she go?"
...
label ch2_prev_schooltime1_loop:
    while sayori_found == False:
        if not renpy.music.get_playing(channel='music') == audio.midnight_piano:
            play music midnight_piano fadeout 1.0
        ...
        menu:
            ...
            "The backyard" if not backyard_check:
                mc "Let's check the backyard... Sometimes I trend to go there and she's looking for me."
                $ ch2_prev_activities_s += 1
                call ch2_prev_schooltime_loop_backyard
                pass
            "Sayori's classroom" if not s_classroom_check:
                if backyard_check == True and sayori_wait2 == True:
            ...
            "The entrance" if not entrance_check:
                if backyard_check == True and sayori_wait2 == False:
    ...
    label ch2_prev_schooltime_loop_backyard:
        ...
        c "Ara-ara [player]... Do you missed something?"
        mc "Eh?"
        play music t6
        ...
        c md "What are you doing here? Shouldn't you be in the dining room lunching right now?"
        mc "I'm looking for my friend Sayori. I haven't seen her where we meet everyday."
        mc "What about you? I haven't seen you in the dining room either..."
        c l4 r4 b1c e1c mc n2 "Well... I already ate something before and, I'm not hungry anymore."
        c b1b e1a mb n1 "Anyway. May I help you with your search?"
        mc "You do? Thank you very much! I appreciate that..."
        c l2 r2 b1a ma "No problems. That's what friends do, right? Ryoma could do the same for you."
        mc "You got a point."
        c l1 r1 e1c "Excellent!"
        if sayori_wait2 == True:
            c l5 mb e1a "Here's a hint: Check in her classroom."
            c "I saw both of you together in the entrance. But I haven't seen her going somewhere else at lunchtime."
            mc "Really? If you're correct, you have my gratitude."
            c l4 r4 e1c ma "Hahaha don't worry about that."
            c b1b e1a mb "Okay, I'm gonna check for her in the women bathroom first. You go where I told you."
            c b1a e1c ma n2 "Good luck [player]~!"
            mc "Thank you very much Camilla..."
            c l1 r1 mb "Hehe, don't mention it~"
            ...
            pass
        if sayori_wait2 == False:
            c r2 e1a b1b md "You know, I saw you waiting for her in the entrance, but after a few minutes you entered alone."
            c l5 r1 b1a mb "Here's a hint: Go to the entrance. I have the feeling she's coming up for lunch."
    ...
    label ch2_prev_schooltime_loop_entrance:
        ...
        if sayori_wait2 == False:
            ...
            mc "What happened? I've been waiting for you in the entrance until 8:55 AM but it was a waste of time."
            show sayori 1k
            mc "Why didn't you answered my calls? I've been very, very worried about you."
            if backyard_check == True:
                mc "Even I called for help to find you in the entire school!"
            s 1l "I feel asleep. I haven't heard the alarms and your phonecalls because I haven't charged my phone's battery at the night."
...
label ch2_prev_schooltime2:
    ...
    menu:
        ...
        "Go pick up Sayori":
            ...
            mc "Hello~?"
            show taro at t11 zorder 2
            sbf "Ah, you must be Sayori's boyfriend."
            sbf "She has just parted to her club already."
            "Me, her boyfriend? {i}*LOL*{/i}"
            mc "Well, thank you..."
            sbf "No problem."
            pass
