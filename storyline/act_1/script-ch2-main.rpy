...
label ch2_main:
    ...
    s 1q "Ehehe..."
    show sayori at t32 zorder 2
    mc "Ehehe... Don't let her fool you."
    ...
    "That was pretty rude, what if the cookie goes through Sayori's eyes and hurts her?"
    show sayori at f32 zorder 3
    s 4m "N-Natsuki!"
    ...
    show yuri 3w at f33 zorder 3
    y "Umm... Okay, if you say so..."
    show yuri at t33 zorder 2
    show sayori 3j at f32 zorder 3
    s "I don't agree [player], Monika is a perfect person!"
    show sayori at t32 zorder 2
    show natsuki 5e at f31 zorder 3
    n "You kinda sounded like a jerk at Monika. What if she hears those things?"
    show natsuki at t31 zorder 2
    ...
    "WHAT THE FUCK?!"
    "I couldn't help but put a cringly smile face after that gesture..."
    "Isn't she going very fast for wanting something with me? Or it's just my imagination? It's just scaring me..."
    ...
    mc "Ah...okay...?"
    mc "But I didn't mean any pressure or anything like that!"
    ...
    mc "I-I see..."
    mc "In that case, b-best of luck."
    m 1j "Thanks~!"
...
label ch2_main_end:
    ...
    if ch2_winner == "Sayori":
        ...
        "It makes me feel more happy now. Maybe I will be more confident the next time."
...
label ch2_end_sayori:
    ...
    mc "Jeez..."
    if ch2_winner == "Camilla":
        mc "I already see her before and after school everyday, even during recess..."
    else:
...
label ch2_end_camilla:
    mc "Walking home with Camilla, huh..."
    "Why does the thought of that make my heart pound...?"
    mc "I mean..."
