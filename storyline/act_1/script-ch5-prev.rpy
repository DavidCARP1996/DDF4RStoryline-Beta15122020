label ch5_prev:
    ...
    if ch4_scene == "monika":
        ...
        "???" "I told you to stay away of some girls but you just kept closer to them..."
        mc "What the fuck do you mean?!"
    ...
    label ch5_sayori_saved:
        ...
        "There's almost light from the window, I look at myself at the mirror..."
        mc "What the..."
        "This scar..."
        ...
        "She with long hair looks more cutier."
        ...
        s "Eh?"
        mc "Oh no..."
        "The ball went too high that traspassed the fences and go directly to the avenue...{w} Here comes the worst part."
        ...
        if persistent.clearall:
            "I guess I'm done. I've spent time with anyone from the Club... Even with Camilla."
        ...
        "You can choose if we can do it or not. There's no problem, it will not affect to our progress anyway."
        menu:
            "What do you say?"
            ...
            "Yes! Do it!":
                ...
                s "[player]?"
                mc "Yeah?"
                s "I feel something in my... butt... I mean... apart of your body..."
                ...
                mc "Uhuhuhu~ Alright!"
                s "How can we start?"
                mc "I'm affraid that we both must take off our clothes."
            ...
            "No! Don't lewd her please!":
                ...
                s "[player]?"
                mc "Yeah?"
                s "Umm, I don't know ifit'smy imagination or..."
                s "I think I feel like the rainclouds are going away more faster."
                mc "That's what I wanted to hear!"
                mc "I knew this plan will work."
                mc "I'm so happy Sayori..."
                s "Hehe~ Me too [player]..."
    ...
    label ch5_sayori_dead:
        ...
        $ dokisaved = "none_saved"
        scene bg bedroom_night
        pause 4.0
        scene bg bedroom_dark with dissolve_cg
        pause 2.0
        scene bg bedroom with dissolve_cg
        mc "Nooooooooooooooooooooooooooooooo{nw}"
        mc "NNNNNOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO!!!!!!!{nw}"
        mc "(!)"
        "What the...?"
        mc "I was...{w} dreaming?"
        ...
        "(...)"
        "I'm thinking about what happened \"in that dream\"..."
        "Could that girl be really Monika?"
        "It can't be a coincidence... Also, she cannot fall so easy to blame herself like that..."
        ...
        "(She's quicky answering LOL)"
        "{i}Hi [player]... well, i was just about to going to the school to advance the preparatives. it's still soon you know? are you excited? everyone is... i'll be waiting for you~ <3{/i}"
        ...
        mc "Anyway, seems like everything was just a nightmare after all..."
