label ch0_prev:
    ...
    "???" "Not even forming a club can make me happy in this...{w=1.0} videogame."
    ...
    "???" "YOU are the CHOOSEN."
    "???" "YOU are the 'Road' I've looking for so long..."
    "???" "What a shame."
    ...
    menu:
        ...
        "No":
            ...
            "Phew!"
            pass
        "Your way to the Reality? What are you talking about?":
            "???" "It's pretty hard to explain..."
            "???" "But I hope you can figure you in any moment."
            mc "Well..."
            "???" "Now, answer my question before I take down your script."
            mc "Yeah, yeah..."
            mc "I didn't said No, and seems like there's no other choice but accept."
            "???" "Perfect!"
            pass
    "..."
    "???" "..."
