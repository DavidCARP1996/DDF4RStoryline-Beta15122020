label ch3_post:
    ...
    pause 3.0
    mc "Dude."
    mc "My house is a mess!"
    mc "I don't know what face I could put if [ch4_name] see this disaster."
    mc "But, we have 2 days left before [ch4_name] drops by. So I can clean this shit tomorrow."
    mc "I'm gonna take a rest."
    pause 2.0
    "..."
    mc "I wonder what's wrong with Sayori..."
    mc "I mean, she never acted like that before."
    mc "Since we know each other, she always acted like the sunshine in my world of darkness."
    mc "She always does her best to cheer up everyone. And you were a witness in the moment when I had to choose with who spend the weekend, that \"sunshine\" was missing compared to the other days."
    mc "The worst of all:{w} She's not in her house again and her phone is still off."
    mc "I don't know what to do about her..."
    pause 2.0
    "..."
    mc "I'm bored."
    mc "Let's finish my poe----{nw}"
    mc "..."
    mc "Shit, that's true, I don't need to write a poem now. Hahahahaha!"
    pause 2.0
    "..."
    mc "I want to go somewhere..."
    if fightingclub_activities < 3:
        "Talking about that, I must go to the Mixed Martial Arts Club."
    mc "Alright! Let's go!"
    scene bg house
    with wipeleft_scene
    jump ch3_post_loop
...
label ch3_post_loop:
    while (stamina > 0):
        ...
        menu:
            ...
            "Go to the cafe" if not cafe_closed:
                $ ch3_post_activities += 1
                call ch3_post_go_to_cafe
                pass
            "Go to the gaming store" if not gamestore_closed:
                $ ch3_post_activities += 1
                call ch3_post_go_to_gaming_store
                pass
            "Go to the library" if not library_closed:
                ...
                $ library_closed = True
                pass
            "Go to the Kick boxing Club" if not fightingclub_closed and fightingclub_activities < 3:
                $ ch3_post_activities += 1
                call ch3_post_go_to_fightingclub
                pass
            "Go home":
                jump ch3_post_go_home
                pass

        pass
    jump ch3_post_go_home

    label ch3_post_go_to_fightingclub:
        ...
        if accept_fightingclub_offer == "Yes":
            ...
            "And yeah, it has something to do with [ch3_winner]..."
            menu:
                mc "Hmm..."
                "Yes":
                    pass
    ...
    label ch3_post_go_to_cafe:
        mc "Hmm..."
        menu:
            "I want to share it with someone else... But with who?"
                ...
                if ch3_winner == "Yuri":
                    ...
                    menu:
                        ...
                        "But I still prefer spend time with you Sayori.":
                            ...
                            s "What a meanie..."
                            pass
                        "I don't know if she wants to talk to me anymore after... you know." if ch3_choice == "mc":
            ...
            "[ch3_winner]" if ch3_winner != "Sayori": # Cita con Yuri/Natsuki/Monika dependiendo de cuál ruta elegiste al escribir el poema.
                ...
                scene bg cafe
                with wipeleft_scene
                if ch3_winner == "Yuri": # Cita con Yuri
                    if ch3_choice == "yuri":
                    ...
                    mc "Me too Yuri."
                    pass
                elif ch3_winner == "Natsuki": # Cita con Natsuki
                    scene bg cafe
                    with wipeleft_scene
                    if ch3_choice == "yuri":
                        n "Hmph!"
                        ...
                        pass
                    pass
                elif ch3_winner == "Monika": # Cita con Monika
                    scene bg cafe
                    with wipeleft_scene
    ...
    label ch3_post_go_to_gaming_store:
...
label ch3_post_go_home:
    stop music fadeout 2.0
    hide screen freeroam_hud
    $ HKBShowButtons()
    $ HKBHideButtons()
    with Dissolve(.5)
    "Well, we have work to do tomorrow."
    "I can't receive [ch4_name] here if my house is a pigsty."
    "I would do it now but..."
    "Nah, I'm fucking tired."
    "See you tomorrow."
