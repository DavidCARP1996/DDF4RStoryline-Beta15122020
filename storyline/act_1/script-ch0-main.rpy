label ch0_main:
    ...
    if ch0_breakfast == True:
        ...
        "That girl is Sayori, my neighbor and best friend since we were children."
    ...
    "I haven't joined on any other club since then. I hate to see the others look at me like a fucking loser considering I was a promise in the soccer club."
    menu:
        "However..."
        "Agree":
            mc "Well..."
    ...
    "I can't come back to the soccer club, I can't even choose any sports clubs because of my bad reputation."
    ...
    "But, geez honestly I hate to mix up with weirdo weebs!"
    ...
    menu:
        ...
        "Accept":
            ...
            s 3a "Yeah??"
            mc "I..."
            "Oh come on, don't be shy you stupid shit, say YES now!!!"
            mc "I'm gonna come to your club."
            s 4r "Yes~!"
            ...
            "That said, I'm gonna try to be a little interested in literature... At least to give Sayori a good impresion."
            mc "With one condition:"
            s 1b "What?"
            mc "Don't be so excited about this. I'm just gonna give a try to your club..."
            mc "At least I know having you at my side I can feel more comfortable than socialize with unknown and weirdos weebs."
            s 4r "Ahahahaha!"
            ...
            "How did she noticed that? Oh, yeah, I mentioned the \"weebs\" word..."
        ...
        "Reject purpose":
            ...
            "In fact, I'm 99\% sure she only did it because she thought it would be fun to help start a new club."
            "Since she was the first one to show interest after the one who proposed the club, she inherited the title \"Vice President\"."
            "That said, At least I could try to give her a good impresion. However, I'm not interested in literature, what a shame..."
            mc "Yeah. I'm going to the computing club."
            show sayori at t11 zorder 2
            s 1g "C'mon, please?"
            ...
            s "Ehehe..."
            mc "Ey! Don't make promises you can't keep. It is of bad luck."
            "I can't tell if Sayori is really that much of an airhead, or if she's so cunning as to have planned all of this out."
            "I let out a long sigh."
            if ch0_breakfast == True:
                mc "Fine fine... I'll stop by because I like to make you happy, even if I'm not on it. Okay?"
                pass
            if ch0_breakfast == False:
                mc "Fine fine... I'll stop by for a cupcake because I'm hungry, okay?"
                pass
    show sayori at h11
    s 4r "Yes! Let's go~!"
    ...
    "Oh, boy... Just look at this..."
    "That body could be the 8th Wonder of the World..."
    ...
    show sayori 1a at t41 at zorder 2
    show monika at t42 at zorder 1
    show natsuki at t43 at zorder 3
    show yuri at t44 at zorder 4
    "I stare at the entire room..."
    ...
    mc "How come you decided to start this kind of club?"
    ...
    "What kind of literature genre could impress her? I only read one thing, but if Monika thinks that genre is ridiculous then I don't think if she could..."
    ...
    "It's very weird, last year she usually looked at me with disgust the entire year. Why is she trying to be nice with me now? Is she plotting something?"
