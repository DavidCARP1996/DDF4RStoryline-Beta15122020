...
label ch1_y_end:
    ...
    if poemopinion == "good":
        ...
        mc "Ah..."
        mc "Me too."
        mc "And thanks for the advices..."
        y 3c "Don't mention it~"
    else:
...
label ch1_n_end:
    ...
    "Hmm... Seems very simple, but I feel like it has a message."
    n 2q "Yeah..."
    ...
    "It isn't a Symbol of Blaze: Destiny reference?"
    "Just remove the 'from the youngest one here' and you will know what I mean... If you're a man of culture of course."
    mc "Yeah...guess not."
...
label ch1_s_end:
    ...
    "Hahaha! What is this?"
    "It only means ONE thing, so let's ask her..."
    mc "Sayori..."
    ...
    mc "...?"
    "I made a doubting expression, doing like I don't trust her."
    s 5b "I forgot to do it last night..."
    mc "You too? Ahahahaha!"
    s 1h "Don't be mean!"
    ...
    s 1d "Really?"
    mc "Yeah."
    mc "Especially that last line... *giggles*"
    s 4r "I made eggs and toast!"
    mc "Even though you were late to school...?"
    mc "I shall consider that."
    "It's because I normally skip the breakfast when I'm very late."
    "But ultimatelly it doesn't seems to be the case..."
    s 5d "It's bad to skip breakfast!"
    s "I get all cranky..."
    mc "Well, I guess you got a point about that..."
    mc "Anyway, thanks for showing me."
    s 1q "Ehehe~"
    s "This was so much fun."
    s "Monika's the best!"
    mc "Ah...yeah, whatever."
    "Where did that come from? It has nothing to do with our conversation..."
    s "But next time, I won't forget."
    s 4x "And I'm gonna write the best poem ever!"
    mc "Nice! I guess I look forward to it."
    return
...
label ch1_m_end2:
    ...
    if poemsread == 0:
        "I don't think it's a regular poem... But I guess I'm not the indicated person to critic a poem."
    elif poemsread == 1:
        "The other poem seems more \"natural\" than this one, but I guess I'm not the indicated person to critic a poem."
    else:
        "The other poems seems more \"natural\" than this one, but I guess I'm not the indicated person to critic a poem."
    ...
    mc "An epiphany?"
    if books_bought == 0:
        "Monika talking about epiphany? That's new, hehe..."
    else:
        "So that's what Monika meaned yesterday. I thought she was just studying it for something not so extrange..."
    m 1a "Yeah...something like that."
    menu:
        mc "And......"

        "What kind of epiphany are you having?":
            pass
        "I'm pretty interested about your epiphany, if you do not mind...":
            pass
...
label ch1_n_bad:
    ...
    n 1o "!!"
    "I guess I put her on her place..."
...
label ch1_n_med:
    if poemwinner[0] == "monika":
        ...
        "Hmm... 50-50? I don't get it at all..."
...
label ch1_n_good:
    ...
    if persistent.clear[0] == True or persistent.clear[2] == True or persistent.clear[6] == True:
        "What the fuck?"
        "I showed her my poems I wrote for anyone else on another timelines, and she hated them!"
        "Seriously, I don't understand this girl..."
    else:
        "Mental note: let's try another route so we can see if she gets mad or not."
    mc "..."
...
label ch1_s_bad:
    ...
    label ch1_s_shared:
        ...
        "...and how much her happiness means to me."
        s 1x "Yeah."
...
label ch1_y_bad:
    ...
    mc "I understand..."
    "I know how that feels... It's not good, you know? It always happens to me when I'm in a complicated situation and I don't know what to do or what to say."
    y "Hold on..."
    y "...Okay."
    ...
    "Holy shit... Just the girl I wanted to impress is dissapointed."
    y 2p "No!!"
    ...
    "But let's be honest: She looks cute~"
...
label m_monika_1:
    ...
    m 1n "I don't know, it's just awesome for someone who never has been into literature."
    "Do you think I am a fucking ignorant who had luck with this poem? Is that it?!"
    mc "So you think I just had luck... isn't?"
    m 2p "Hahahahahaha! No dummy, don't say such thing!"
    m 2a "I guess I...underestimated you!"
    mc "I knew it."
    m 4b "But don't worry, you have potential for this. Just keep it up, okay?"
    mc "Whatever..."
    m 5 "I'm glad to hear that."
    return

label m_camilla_1:
    m "..."
    m "{i}(How pathetic...){/i}"
    mc "Uh... Did you said something?"
    m "Eh?"
    m "Aaaaaaah... Ahahahaha!"
    m "Sorry, I was spacing out."
    mc "... ... ..."
    mc "There's something wrong with my poem?"
    m "Ah... No!"
    m "Not at all I mean..."
    m "It's just..."
    mc "Speak!"
    m "Well, seems obvious that you're almost starting on this of poem writing."
    m "The poem is not so bad at all, but I see some {i}failures{/i}."
    mc "I knew it..."
    m "In other way, it seems that you got inspired on...{w} Camilla?"
    m "At least I bet she would like such stuff."
    mc "And there's something wrong with that?"
    m "No! Aah--"
    if y_readpoem:
        mc "Yuri liked my poem a lot."
    if n_readpoem:
        mc "Natsuki liked it."
    if s_readpoem:
        mc "Sayori was obvious that she would like it."
    if y_readpoem or n_readpoem or s_readpoem:
        mc "So based on that, it's obvious that the problem here is your conflict with Camilla."
    mc "What's wrong with you Monika? I thought you changed!"
    m "M-Me... Ahh--"
    m "Okay, okay! You win..."
    m "I'm sorry, okay?"
    mc "(...)"
...
label m_camilla_2:
    ...
    m 1c "... ... ..."
    mc "You know..."
    mc "If you hate this poem, then that means you still hate me as well."
    m "What?!"
    m "[player], that makes no sense!"
    m "I never hated you by the way!"
    mc "If you say so..."
    m "Grrr--!!"
    m "Listen [player], you can think anything about me. Anything!"
    m "But I won't tolerate such attitude of yours."
    mc "... ... ..."
    m "I'm giving you the chance to be closest friends, but you're not making any kind of effort!"
    m "You're still withdrawn to me like if I've made you a lot of damage in the past."
    "Sort of."
    m "In fact, I shall consider that you must stay away from Camilla."
    m "Despite the fact that those poems aren't proving nothing of effort..."
    m "Seems like she's doing all the posible to keep you away from my side."
    mc "What are you talking about Monika?"
    mc "Camilla doesn't care about if we're friends or not. She only wants the best for me."
    mc "Also, the other girls in the club still loves these poems."
    mc "You're the only one here rejecting them!"
    m "... ... ..."
    mc "Look, let's forget about this and let's change of topic, okay?"
    m "Whatever..."
    return
...
label m_monika_2:
    if ch1_winner == "Monika":
        ...
        if ch1_winner == "Yuri" or ch1_winner == "Camilla":
...
label m_monika_3:
    if ch1_winner == "Monika" and ch2_winner == "Monika":
        ...
        mc "Listen, it's okay. If I hate you for all that, then I never wanted to spend time with you..."
        ...
        mc "Monika... I..."
        mc "I'm Sorry, but I already have plans for tonight."
        m "I see..."
        ...
        if ch2_winner == "Yuri" or ch1_winner == "Camilla":
